...
function [deltaT,ratio]=TDTR_REFL_VV3(tdelay,TCR,tau_rep,f,lambda,C,t,eta,r_pump,r_probe,A_pump)
...
kmax=1/sqrt(r_pump^2+r_probe^2)*1.5;
    ...
    dT1=rombint_VV3(@(kvect) TDTR_TEMP_VV3(kvect,mvect/tau_rep+f,lambda,C,t,eta,r_pump,r_probe,A_pump),0,kmax,length(mvect));
    dT2=rombint_VV3(@(kvect) TDTR_TEMP_VV3(kvect,mvect/tau_rep-f,lambda,C,t,eta,r_pump,r_probe,A_pump),0,kmax,length(mvect));
