for ii=1:length(lambda)
    ...
    Ctemp=C;
    Ctemp(ii)=C(ii)*1.01;
    [deltaR_data_C(:,ii),ratio_data_C(:,ii)]=TDTR_REFL_VV3(tdelay,TCR,tau_rep,f,lambda,Ctemp,t,eta,r_pump,r_probe,A_pump);
    ...
    [deltaR_data_L(:,ii),ratio_data_L(:,ii)]=TDTR_REFL_VV3(tdelay,TCR,tau_rep,f,lambdatemp,C,t,etatemp,r_pump,r_probe,A_pump);
    ...
    ttemp=t;
    ttemp(ii)=t(ii)*1.01;
    [deltaR_data_t(:,ii),ratio_data_t(:,ii)]=TDTR_REFL_VV3(tdelay,TCR,tau_rep,f,lambda,C,ttemp,eta,r_pump,r_probe,A_pump);
    ...
    [deltaR_data_eta(:,ii),ratio_data_eta(:,ii)]=TDTR_REFL_VV3(tdelay,TCR,tau_rep,f,lambda,C,t,etatemp,r_pump,r_probe,A_pump);
...
[deltaR_data_r_pump,ratio_data_r_pump]=TDTR_REFL_VV3(tdelay,TCR,tau_rep,f,lambda,C,t,eta,r_pumptemp,r_probetemp,A_pump);
